/*
  ...
  Also make sure to have the right settings in system_stm32f4xx.c for input
  clock.
*/
...
int main(void) {
  ...
  /*
    Config global system timer to make interrupt every 1us -> microsecond
    counter
  */
...
void USART1_Setup() {
  ...
  USART_InitStruct.USART_StopBits =
      USART_StopBits_1; // increase this if you have "slow end"
  USART_InitStruct.USART_Parity =
      USART_Parity_No; // change if data integrity is important
